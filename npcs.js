...
var GetOccupation = function(isRural) {
	...
	if (rand <= 1) {
		...
		if (rand2 <= 1) {
			...
			occupation.Secondary = "Torturer/Interrogator";
			occupation.Description = capitalizeFirstLetter("");
			occupation.Classes = LookupOccupation(occupation.Primary, occupation.Secondary).Classes;
			occupation.ExtraChoices = LookupOccupation(occupation.Primary, occupation.Secondary).SkillProficiencies;
			occupation.SkillProficiencies = [];
		...
		if (rand2 <= 1) {
			...
			occupation.Secondary = "Monk/Nun";
			occupation.Description = capitalizeFirstLetter("an academic devoted to prayer and spirituality");
			occupation.Classes = LookupOccupation(occupation.Primary, occupation.Secondary).Classes;
			occupation.ExtraChoices = LookupOccupation(occupation.Primary, occupation.Secondary).SkillProficiencies;
			occupation.SkillProficiencies = [];
			for (i=0; i < 2; i++) {
		...
		if (rand2 <= 1) {
			...
			occupation.Secondary = "Hunter/Trapper";
			...
			occupation.Secondary = "Hunter/Trapper";
			occupation.Description = capitalizeFirstLetter("small game");
			occupation.Classes = LookupOccupation(occupation.Primary, occupation.Secondary).Classes;
			occupation.ExtraChoices = LookupOccupation(occupation.Primary, occupation.Secondary).SkillProficiencies;
			occupation.SkillProficiencies = [];
			for (i=0; i < 2; i++) {
		...
		if (rand2 <= 1) {
			...
			occupation.Secondary = "Dancer/Acrobat";
			occupation.Description = capitalizeFirstLetter("");
			occupation.Classes = LookupOccupation(occupation.Primary, occupation.Secondary).Classes;
			occupation.ExtraChoices = LookupOccupation(occupation.Primary, occupation.Secondary).SkillProficiencies;
			occupation.SkillProficiencies = [];
			...
			occupation.Secondary = "Musician/Minstrel/Poet";
			occupation.Description = capitalizeFirstLetter("(‘bard' without the good stuff");
			occupation.Classes = LookupOccupation(occupation.Primary, occupation.Secondary).Classes;
			occupation.ExtraChoices = LookupOccupation(occupation.Primary, occupation.Secondary).SkillProficiencies;
			occupation.SkillProficiencies = [];
			for (i=0; i < 2; i++) {
